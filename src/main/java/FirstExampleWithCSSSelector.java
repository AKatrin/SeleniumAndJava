...
public class FirstExampleWithCSSSelector {
    ...
    private static void openImage(WebDriver driver) {
        ...
        driver.findElement(By.cssSelector("[name=q]")).sendKeys("Naruto");
        ...
        List<WebElement> imagenes = driver.findElements(By.cssSelector("img"));
        try {
            Thread.sleep(15000);
        } catch (InterruptedException e) {
            e.printStackTrace();
